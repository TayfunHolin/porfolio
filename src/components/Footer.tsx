        ...
        <div className="grid md:grid-cols-[1.5fr_1fr_1fr_1fr] gap-12 md:gap-8">
          ...
          <div className="md:pr-8">
            ...
            <div className="flex items-center gap-4">
              <a href={siteConfig.social.linkedin} target="_blank" rel="noopener noreferrer" className="text-text-tertiary hover:text-indigo-400 transition-colors">
              ...
              <a href="https://github.com/TayfunHolin" target="_blank" rel="noopener noreferrer" className="text-text-tertiary hover:text-indigo-400 transition-colors">
              ...
              <a href="https://instagram.com/" target="_blank" rel="noopener noreferrer" className="text-text-tertiary hover:text-indigo-400 transition-colors">
              ...
              <a href={siteConfig.social.twitter} target="_blank" rel="noopener noreferrer" className="text-text-tertiary hover:text-indigo-400 transition-colors">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </a>
              <a href="https://medium.com/" target="_blank" rel="noopener noreferrer" className="text-text-tertiary hover:text-indigo-400 transition-colors">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-1 list-none">
              <li>
                <Link to="/works" className="text-text-secondary hover:text-indigo-400 transition-colors text-sm">
                  Works
                </Link>
              </li>
              <li>
                <Link to="/articles" className="text-text-secondary hover:text-indigo-400 transition-colors text-sm">
                  Articles
                </Link>
              </li>
              <li>
                <Link to="/experience" className="text-text-secondary hover:text-indigo-400 transition-colors text-sm">
                  Experience
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-text-secondary hover:text-indigo-400 transition-colors text-sm">
                  About
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-1 list-none">
              <li>
                <a
                  href="https://github.com/TayfunHolin"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 text-text-secondary hover:text-indigo-400 transition-colors text-sm group"
                >
